...
if __name__ =='__main__':
    reader = SquadReaderFilter()
    passage_lens = []
    for instance in reader._read('/home/aman/Documents/squad2/squad-train-v1.1.json'):
        passage_len = len(instance.fields['passage'].tokens)
        passage_lens.append(passage_len)
    print(Counter(passage_lens))