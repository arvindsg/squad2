...
class BidirectionalAttentionFlowWithNoAnswerOptionNormalised(Model):
    """
    ...
    def __init__(self, vocab: Vocabulary,
                 ...
                 modeling_layer: Seq2SeqEncoder,
                 span_end_encoder: Seq2SeqEncoder,
                 no_answer_encoder:Seq2VecEncoder,
                 dropout: float = 0.2,
                 mask_lstms: bool = True,
                 initializer: InitializerApplicator = InitializerApplicator(),
                 regularizer: Optional[RegularizerApplicator] = None) -> None:
        super(BidirectionalAttentionFlowWithNoAnswerOptionNormalised, self).__init__(vocab, regularizer)
        ...
        self._no_anwswer_encoder=no_answer_encoder
        ...
        no_answer_encoding_dim=no_answer_encoder.get_output_dim()
        no_answer_input_dim=encoding_dim*6+no_answer_encoding_dim
        self._no_answer_predictor= torch.nn.Linear(no_answer_input_dim,1)
